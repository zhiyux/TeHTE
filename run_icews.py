...
parser.add_argument('-init4', help='init4', type=float, default=2e-7)
...
parser.add_argument('-sample_size', help='Negative sample size', type=int, default=1024)
